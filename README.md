...
location. If you'd like to host your own dialog, though, you can:
  ...
  2. In the `webxray` repository, copy the file `src/settings.js` to
  `src/settings.local.js`, and then modify its `mixMasterDialogURL` setting to
  point to your hosted instance of the dialog.
